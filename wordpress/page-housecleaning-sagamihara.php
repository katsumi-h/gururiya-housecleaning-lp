...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .hc-photo--area { aspect-ratio: 1120 / 602; margin-top: 24px; border-radius: 12px; }
...
<main>
  ...
  <section class="hc-hero">
    ...
    <div class="hc-container hc-hero__grid">
      <div>
        ...
        <p class="hc-hero__copy">何年も気になっている黒カビや油汚れはありませんか？<br>浴室だけ換気扇だけでもお受けします<br><strong class="hc-hero__note">座間市・大和市も全域へ伺います</strong></p>
      </div>
  ...
  <section class="hc-section hc-section--tint" id="area">
    <div class="hc-container">
      ...
      <p class="hc-lead">相模原市・町田市・座間市・大和市は全域へ伺います。そのほかのエリアも、場所によってお受けできます。</p>
      ...
      <ul class="hc-area-list">
        ...
        <li class="hc-area-chip"><span aria-hidden="true">📍</span>座間市</li>
        <li class="hc-area-chip"><span aria-hidden="true">📍</span>大和市</li>
      </ul>
      <p class="hc-area-label">この区と地域へ伺います</p>
      <ul class="hc-area-list">
        ...
        <li class="hc-area-chip hc-area-chip--part"><span aria-hidden="true">📍</span>厚木市の北部</li>
  ...
  <section class="hc-section" id="flow">
    <div class="hc-container">
      ...
      <div class="hc-flow">
        ...
        <article class="hc-flow__item"><div><h3>03　クリーニング</h3><p><strong>始める前にどこをどう洗うかを一緒に見ます。</strong>立ち会いは最初と最後だけで大丈夫です。途中でお出かけになっても構いません。<strong>ずっとお留守の場合は始める前と終わったあとの写真をお送りしてお電話でご報告します。</strong></p></div><img class="hc-photo hc-photo--flow" src="<?php echo get_stylesheet_directory_uri(); ?>/images/flow-cleaning.jpg" width="1100" height="688" loading="lazy" decoding="async" alt="浴室のタイルの壁を手作業で洗っているところ"></article>
