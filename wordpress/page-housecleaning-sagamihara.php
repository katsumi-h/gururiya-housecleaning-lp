...
<main>
  ...
  <section class="hc-section hc-section--tint" id="service">
    <div class="hc-container">
      ...
      <div class="hc-service-grid">
        <article class="hc-service"><div class="hc-image-slot hc-image-slot--service" data-image-slot="bathroom" role="img" aria-label="浴室クリーニング画像を入れる予定"><div class="hc-image-slot__inner"><span class="hc-image-slot__icon">📷</span><strong>浴室の画像</strong><small>推奨：横位置</small></div></div><div class="hc-service__top"><span class="hc-service__label">BATHROOM</span><h3>浴室クリーニング</h3><p><strong>天井から排水口まで。</strong>自分ではやりにくい場所を、専用の洗剤と道具で洗います。</p><p><strong>洗う場所</strong>／浴槽・天井・壁・床・ドア・鏡・蛇口・金具・排水口・照明・換気扇のまわり・小物</p><p><strong>作業時間の目安：約2時間</strong></p><p>水垢や石鹸かすで白くなっていた浴槽やタイルから、元の色が出てきます。黒カビも取れます。</p></div></article>
        <article class="hc-service"><div class="hc-image-slot hc-image-slot--service" data-image-slot="kitchen" role="img" aria-label="キッチンクリーニング画像を入れる予定"><div class="hc-image-slot__inner"><span class="hc-image-slot__icon">📷</span><strong>キッチンの画像</strong><small>推奨：横位置</small></div></div><div class="hc-service__top"><span class="hc-service__label">KITCHEN</span><h3>キッチンクリーニング</h3><p><strong>油と水あかを、両方落とします。</strong>キッチンは汚れの種類が多いので、場所ごとに洗剤を使い分けます。</p><p><strong>洗う場所</strong>／シンク・排水口・蛇口・調理台・コンロ・魚焼きグリル（中まで）・収納の扉（外側）・窓の内側</p><p><strong>作業時間の目安：約2時間</strong></p><p>油で黒ずんでいたコンロと、白く曇っていたシンクから、元の色が出てきます。</p></div></article>
        <article class="hc-service"><div class="hc-image-slot hc-image-slot--service" data-image-slot="range-hood" role="img" aria-label="レンジフード画像を入れる予定"><div class="hc-image-slot__inner"><span class="hc-image-slot__icon">📷</span><strong>レンジフードの画像</strong><small>推奨：横位置</small></div></div><div class="hc-service__top"><span class="hc-service__label">RANGE HOOD</span><h3>レンジフード（換気扇）クリーニング</h3><p><strong>換気扇は分解洗浄します。</strong>フードの中にたまった油は外からふいても落ちません。<strong>外さないと届きません。</strong></p><p><strong>洗う場所</strong>／手前の板・フィルター・中のファン・ファンのまわり・本体の外側</p><p><strong>作業時間の目安：約1時間</strong></p><p>茶色い油の膜が取れて、ファンの金属の色が出てきます。</p></div></article>
        <article class="hc-service"><div class="hc-image-slot hc-image-slot--service" data-image-slot="toilet" role="img" aria-label="トイレクリーニング画像を入れる予定"><div class="hc-image-slot__inner"><span class="hc-image-slot__icon">📷</span><strong>トイレの画像</strong><small>推奨：横位置</small></div></div><div class="hc-service__top"><span class="hc-service__label">TOILET</span><h3>トイレクリーニング</h3><p><strong>便器の中も外も、床と壁まで洗います。</strong></p><p><strong>洗う場所</strong>／便器・便座・ウォシュレットのノズル・タンクの表面と手洗い・ペーパーホルダー・収納の扉（外側）・壁・床・幅木（壁の下のふち）・換気口の表面</p><p><strong>作業時間の目安：約1時間</strong></p><p>便器のふちの黒ずみと、たまっている水のまわりについた汚れが取れます。排水管やトイレ特有の臭いも、汚れと一緒になくなります。</p></div></article>
        <article class="hc-service"><div class="hc-image-slot hc-image-slot--service" data-image-slot="air-conditioner" role="img" aria-label="エアコンクリーニング画像を入れる予定"><div class="hc-image-slot__inner"><span class="hc-image-slot__icon">📷</span><strong>エアコンの画像</strong><small>推奨：横位置</small></div></div><div class="hc-service__top"><span class="hc-service__label">AIR CONDITIONER</span><h3>エアコンクリーニング</h3><p><strong>フィルターを外すだけでは、中のカビには届きません。</strong></p><p><strong>洗う場所</strong>／フィルター・送風ファン・熱交換器・吹き出し口・ルーバー・本体カバー</p><p><strong>作業時間の目安：約2時間</strong></p><p>中を覗くと、カビがびっしりついています。吹き出し口の黒い点も、カビ臭いにおいも、汚れと一緒になくなります。</p></div></article>
  ...
  <section class="hc-section hc-section--cream" id="faq">
    <div class="hc-narrow">
      ...
      <div class="hc-faq">
        ...
        <details><summary>女性の一人暮らしですが、大丈夫ですか？</summary><div class="hc-faq__answer"><p>当日伺う人は事前にお伝えします。身分証をお見せしてから家に上がります。入る場所も先にお伝えします。お伝えした場所以外には入りません。作業の間ずっと見ていただいて構いません。</p></div></details>
      </div>
    </div>
  </section>
  ...
  <section class="hc-cta">
    <div class="hc-container">
      ...
      <ul class="hc-bonus">
        <li>見積もりも出張費もいただきません</li>
        <li>見積もりのあと、その場で決めなくて構いません</li>
        <li>2か所まとめると7%、3か所まとめると10%お安くなります</li>
      </ul>
      <div class="hc-actions">
