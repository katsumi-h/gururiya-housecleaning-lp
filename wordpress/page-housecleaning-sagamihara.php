...
<main>
  ...
  <section class="hc-section hc-section--tint" id="area">
    <div class="hc-container">
      ...
      <img class="hc-photo hc-photo--area" src="<?php echo get_stylesheet_directory_uri(); ?>/images/area-map.svg" width="1120" height="602" loading="lazy" decoding="async" alt="対応エリアの地図。相模原市と町田市の全域へ伺います">
